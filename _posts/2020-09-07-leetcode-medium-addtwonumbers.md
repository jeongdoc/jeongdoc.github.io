...
## 고려해야할 부분
l1과 l2의 길이가 다를 수 있다는 점을 고려, null체크만 유의한다면 수월하게 풀 수 있습니다.    
난 Iteration으로 문제에 접근하였는데 Leetcode의 다른 사람들 풀이도 참고해보니 Recursion으로도 접근할 수 있었습니다.    
Recursion을 선호하지 않아서 미처 고려하지 못했던 접근법이었습니다.
